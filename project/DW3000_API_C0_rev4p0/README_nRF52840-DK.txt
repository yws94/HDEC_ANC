...
for this document was V4.52c, 64-bit running on Windows 10. You can find the
application at:
...
was the 16.0.0 nRF5 SDK. Newer versions of the SDK may work with this code, but
...
"<DW3000 API Root Directory>/API/nRF52840-DK/SDK"

The "<DW3000 API Root Directory>" is the same directory that
...
"<DW3000 API Root Directory>/API/nRF52840-DK/dw3000_api.emProject"
...
this software package (the same directory as this README).
...
following directory:
"<DW3000 API Root Directory>/API/nRF52840-DK"
